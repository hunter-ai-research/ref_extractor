...
def main() -> None:
    ...
    with open("/Users/pavlikenemy/school/research/ai/programs/ref_extractor/response.json", "r") as f:
        references = extractor._extract_references_from_response(json.loads(f.read()))
